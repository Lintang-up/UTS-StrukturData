//Muhammad Lintang Pamungkas
//210103028
//21 TIA1

/*Disini saya menggunakan software DEV C++*/
...
penjualan susu[100];		//untuk array record	
penjualan temp[100];		//untuk buble sort
...
int main() 
{
    ...
    cout << "+---------------------------------------+" << endl;
    cout << "|Menu:                                  |" << endl;
    cout << "|1. Input SUSU                          |" << endl;
    cout << "|2. Daftar List                         |" << endl;
    cout << "|3. Pengurutan SUSU  (Jumlah pesanan)   |" << endl;
    cout << "|4. Keluar                              |" << endl;
    cout << "+---------------------------------------+" << endl;
	 ...
	 int a; //deklarasi perulangan a	
{
        ...
        for (int x = 1; x<i; x++)
    {
        for (int j = 0; j <i - x; j++)
        {
            //ascending berdsarkan banyak susu
