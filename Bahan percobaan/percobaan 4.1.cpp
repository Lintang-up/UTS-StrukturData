...
void lihatdata()
{
	...
	cout << "-----------------------------------------------------------------------------------------------------------" << endl << endl << endl;
	cout << "tekan untuk kembali ke menu...." << endl;
getch();
}
	...
	if (menuSS == 1)
	{
		...
		if(found){
			...
			for (a = 0; a < j; a++)
			{
				...
				cout << setprecision(4) <<" "			   << temp[a].nilai1;
				cout << setprecision(4) <<"        "	   << temp[a].nilai2;
				cout << setprecision(4) <<"        "	   << temp[a].nilai3;
				cout << setprecision(4) <<"      "		   << temp[a].hasil;
				cout << setprecision(4) <<"     "	       << temp[a].Grade;
				cout <<endl;
			}
			cout << "\n\nDitemukan : " << j << endl;
			cout << "-----------------------------------------------------------------------------------------------------------" << endl;
...
void bubble()
{
    ...
    lihatdata();
    cout << "\n\nTekan Untuk Kembali Ke Menu...." << endl;
    getch();
}
