...
if(found){
	...
	cout << setprecision(4) <<"     "	       << jumlah[i].Grade <<endl; cout<<endl;
		  ...
		  for(i=1; i<=J; i++){
          for(j=1; j<=J; j++){
              if(jumlah[i].nim<jumlah[j].nim){
                 temp=jumlah[i].nim;
                  jumlah[i].nim=jumlah[j].nim;
                  jumlah[j].nim=temp;
               }
            }
         }	
       ...
       {
        {
			...
			{
			cout << setiosflags(ios::left) << setw(4)  << i;
			cout << setiosflags(ios::left) << setw(11) << jumlah[y].nim;
			cout << setiosflags(ios::left) << setw(17) << jumlah[y].nama;
			cout << setiosflags(ios::left) << setw(17) << jumlah[y].prodi;
			cout << setiosflags(ios::left) << setw(17) << jumlah[y].asal;
			cout << setprecision(4) <<" "			   << jumlah[y].nilai1;
			cout << setprecision(4) <<"        "	   << jumlah[y].nilai2;
			cout << setprecision(4) <<"        "	   << jumlah[y].nilai3;
			cout << setprecision(4) <<"        "	   << jumlah[y].nilai4;
			cout << setprecision(4) <<"       "		   << jumlah[y].nilai5;
			cout << setprecision(4) <<"      "		   << jumlah[y].hasil;
			cout << setprecision(4) <<"     "	       << jumlah[y].Grade <<endl; cout<<endl;
			}	
        }
       }
